                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Profession" name="label" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer01">Min Income</label>
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Profession" step="0.01" name="min_income" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer01">Max Income</label>
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Profession" step="0.01" name="max_income" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
