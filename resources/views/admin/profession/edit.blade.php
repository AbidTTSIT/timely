                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.profession', $profession->id) }}" method="post">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer01">Profession</label>
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Profession" name="name" value="{{ $profession->name }}" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer02">Status</label>
                                        <select name="status" id="" class="form-control border-success">
                                            <option value="" disabled>Select Status</option>
                                            <option value="active" {{ $profession->status == 'active' ? 'selected' : '' }}>Active</option>
                                            <option value="inactive" {{ $profession->status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <a href="{{ route('profession') }}" class="btn btn-light btn-pill" type="button">
                                    Cancel
                                </a>
                            </form>
                        </div>
