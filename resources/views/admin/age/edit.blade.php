                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.age', $age->id) }}" method="post">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer01">Label</label>
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Label" name="label" value="{{ $age->label }}" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer01">Min Income</label>
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Min Age" step="0.01" name="min_age" value="{{ $age->min_age }}" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer01">Max Income</label>
                                        <input type="text" class="form-control border-success" id="validationServer01"
                                            placeholder="Enter Max Age" step="0.01" name="max_age" value="{{ $age->max_age }}" required />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="validationServer02">Status</label>
                                        <select name="status" id="" class="form-control border-success">
                                            <option value="" disabled>Select Status</option>
                                            <option value="active" {{ $age->status == 'active' ? 'selected' : '' }}>Active</option>
                                            <option value="inactive" {{ $age->status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
